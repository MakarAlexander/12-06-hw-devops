# Домашнее задание к занятию «Хранение в K8s. Часть 1» "Макарцев Александр Владимирович"
...
#### Решение
Конфигурация [deployment](./deployment.yaml)  
...
#### Решение
Конфигурация [daemonset](./daemonset.yaml)  
